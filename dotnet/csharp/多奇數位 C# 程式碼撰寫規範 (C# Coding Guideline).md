...
* 匿名函式應宣告為 `static`。
  ...
  如果匿名函式不需要存取外部變數，則應宣告為 `static`，以提高程式碼的效能。

* 局部函式應宣告為 `static`。

  如果局部函式不需要存取外部變數，則應宣告為 `static`，以提高程式碼的效能。
...
* 應優先使用局部函式而非匿名函式。
  ...
  如果需要使用函式，且函式不需要存取外部變數，則應優先使用局部函式，以提高程式碼的效能。
