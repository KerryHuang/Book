...
我們在 [耦合篇](https://igouist.github.io/post/2020/09/oo-8-cohesion-and-coupling) 提過，物件彼此有關聯就會產生耦合，而不好的耦合就會散發出臭味。為了方便管理和降低複雜性，減少臭味出現的機率，我們的目標就是降低耦合。

相對於 [依賴反轉原則](https://igouist.github.io/post/2020/12/oo-14-dependency-inversion-principle) 利用 [抽象和介面](https://igouist.github.io/post/2020/07/oo-7-interface) 的方式在模組之間做出隔離和控制的作法。最少知識原則則是利用 [封裝](https://igouist.github.io/post/2020/07/oo-3-encapsulation) 的概念來解除耦合，畢竟，關聯越少耦合也越少嘛。
...
例如人原本可以直接把電線接起來讓燈泡亮起來，但為了把電線使燈泡變亮這件事的複雜度封裝起來，我們就必須要有一個開關，再把電線放到開關後面去，變成了人按下開關，開關藉由電線點亮燈泡等等，整體來說會使系統內的類別變多。
