---
kind: reprint
source: site:github.com/adam-p/markdown-here
author: adam-p (Markdown Here Cheatsheet 中文譯本)
---
...
⋅⋅⋅要使文字斷行而不會成為新的段落，你只需要在後面加上兩個空白。⋅⋅
⋅⋅⋅注意這行已經分開了，不過還是在同樣的段落中。
⋅⋅⋅（如果不要求後面的兩個空格，就違反了典型的 GFM 斷行格式。）
...
[參考](https://medium.com/@mdzeng/寫作-筆記神器markdown-真希望我學生時期就懂-26becb160f6e)
