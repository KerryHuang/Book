...
4. [請問你對資料庫正規化的了解和實際應用情況是什麼？](#database_04)
5. [什麼是資料庫死鎖？如何預防和解決死鎖問題？](#database_05)
6. [SQL Server 如何備份和還原資料庫？列舉一些常見的資料庫備份和還原方案。](#database_06)
7. [如何追踨查詢過久的SQL 語法？](#database_07)
8. [SQL Server 如何清除交易紀錄檔？](#database_08)
...
4. [請問您對 ASP.NET 的理解是什麼？請講解一下 ASP.NET 的特點和使用情況。](#developer_04)
5. [請問您對 MVC 架構的理解是什麼？在 .NET 開發中，如何使用 MVC 架構？](#developer_05)
6. [在使用 .NET 開發 Web 應用時，您會使用哪些前端框架？為什麼？](#developer_06)
7. [請問您對單元測試的理解是什麼？在 .NET 開發中，如何進行單元測試？](#developer_07)
8. [請問您有沒有使用過 Entity Framework？請講解一下您對 Entity Framework 的理解和使用情](#developer_08)
9. [在 .NET 開發中，您會使用哪些常用的第三方庫？請問您對這些庫的理解和使用情況是什麼？](#developer_09)
10. [請問您在 .NET 開發中遇到過哪些困難和挑戰？您是如何解決的？](#developer_10)
11. [.NET 網站實作快取有哪幾種方式?](#developer_11)
12. [.NET 開發中使用的報表開發工具有哪些？例如：Reporting Service、Crytal Report](#developer_12)
13. [C# 產生PDF方式有哪些？(薪資單、發票、物流標籤)](#developer_13)
14. [有用過的ETL工具有哪些？例如：SSIS](#developer_14)
15. [FTP傳輸有分哪幾種？](#developer_15)
16. [.NET 開發工作排程有哪些方式？您會使用哪些常用的第三方庫？Hangfire、Windows 排程器等](#developer_16)
...
4. [程式開發版本控管有哪些工具？什麼是Pull request？](#soft_04)
5. [什麼是Code Review？Code Review需要注意哪些地方？](#soft_05)
