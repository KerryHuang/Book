...
1. [Microsoft Word](https://apps.apple.com/tw/app/microsoft-word/id462054704?mt=12)
2. [Microsoft Excel](https://apps.apple.com/tw/app/microsoft-excel/id462058435?mt=12)
3. [Microsoft PowerPoint](https://apps.apple.com/tw/app/microsoft-powerpoint/id462062816?mt=12)
4. [Microsoft OneNote](https://apps.apple.com/tw/app/microsoft-onenote/id784801555?mt=12)
5. [Microsoft Remote Desktop](https://apps.apple.com/tw/app/microsoft-remote-desktop/id1295203466?mt=12)
6. [Microsoft OneDrive](https://apps.apple.com/tw/app/onedrive/id823766827?mt=12)
7. [Microsoft ToDo](https://apps.apple.com/tw/app/microsoft-to-do/id1274495053?mt=12)

---

## Developer

1. [Visual Studio 2022](https://visualstudio.microsoft.com/zh-hant/vs/mac/)
...
1. [Azure Data Studio](https://docs.microsoft.com/zh-tw/sql/azure-data-studio/download-azure-data-studio?view=sql-server-ver16)
2. [DBeaver](https://dbeaver.io/download/)
3. [MySQLWorkbench](https://dev.mysql.com/downloads/workbench/)
4. [DB Browser](https://sqlitebrowser.org/dl/)
...
1. [Camunda](https://camunda.com/get-started/)
2. [draw.io](https://github.com/jgraph/drawio-desktop/releases/)
3. [XMind](https://www.xmind.net/download/)
4. [Archi](https://www.archimatetool.com/download/)

---

## Browser

1. [Chrome](https://www.google.com/intl/zh-TW/chrome/?brand=CHBD&gclid=CjwKCAjw_ISWBhBkEiwAdqxb9kKKNaBACF4j0fzdnij_OoHYAfFxY3N2TeQEvGALcmmMdt_LE-2PcRoCyb4QAvD_BwE&gclsrc=aw.ds)
2. [Firefox](https://www.mozilla.org/zh-TW/firefox/new/)
3. [Edge](https://www.microsoft.com/zh-tw/edge)
...
1. [Line](https://apps.apple.com/tw/app/line/id539883307?mt=12)
2. [Teams](https://www.microsoft.com/zh-tw/microsoft-teams/download-app)
...
1. Microsoft Packages：
  ...
  - [Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation](https://learn.microsoft.com/zh-tw/aspnet/core/mvc/views/view-compilation?view=aspnetcore-7.0&tabs=visual-studio)：動態編譯 [ASP.NET](http://asp.net/) Core Razor 檔案。
...
2. [Autofac](https://autofac.org/)：DI 套件。
3. [AutoMapper](https://automapper.org/)：將 Object 值映射到另一個 Object。
4. [Dapper](https://github.com/DapperLib/Dapper)：輕量化的 ORM 套件。
5. [FluentValidation](https://docs.fluentvalidation.net/en/latest/)：建構強類型驗證規則。
6. [Humanizer](https://github.com/Humanizr/Humanizer)：功能非常強大的字串轉換工具，可將時間、數字轉換成口語化英文、英文單複數轉轉換，及各種字句 Format。
...
11.  [SSH.NET](https://github.com/sshnet/SSH.NET)：SFTP 套件。
12.  [FluentFTP](https://github.com/robinrodricks/FluentFTP)：FTP 套件。
13.  JSON 相關套件：
...
3. [.NET Core Extension Pack](https://marketplace.visualstudio.com/items?itemName=doggy8088.netcore-extension-pack)
...
2. [SQL Complete](https://www.devart.com/dbforge/sql/sqlcomplete/editions.html)

## Azure DevOps Extension
1. [SonarCloud](https://marketplace.visualstudio.com/items?itemName=SonarSource.sonarcloud)
2. [Mend Bolt (formerly WhiteSource)](https://marketplace.visualstudio.com/items?itemName=whitesource.whiteSource-bolt-v2)