---
kind: reprint
source: https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/
author: Kodofish
---
...
![Add Roles and Features](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image02.png)

## 設定 APPLICATION POOL

在 IIS 裡找到你的網站應用程式所使用的 Application Pool，按右鍵叫出選單，點選 Advanced Settings

![Click Advanced Settings](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image03.png)
...
![Modify setting](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image04.png)
...
![Click Advanced Settings](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image05.png)

將 Preload Enabled 設定為 True。
![Set Preload Enabled is true](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image06.png)

## 驗證

照著步驟做應該就能夠設定完成了，你可以將工作管理員打開，找到網站應用程式的執行緒，點選 End Task 將它關閉。 
![Before](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image07.png)

有設定成功的話就會馬上再生出一個新的執行緒，可以看到 PID 會有所不同。
![After](https://kodofish.dev/post/2021-04-08_how_to_keep_and_running_web_application_on_iis/images/image08.png)
