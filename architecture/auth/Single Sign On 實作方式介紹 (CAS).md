...
代表判斷使用者是不是他所宣稱的人, 通常會透過使用帳號密碼或是郵件等等方式進行認證
而認證成功後, 有沒有被授權存取服務的權限則是另一個單詞 Authorization
...
[![Case A](https://yu-jack.github.io/images/sso/case-01.png)](https://yu-jack.github.io/images/sso/case-01.png)

[Case A](https://yu-jack.github.io/images/sso/case-01.png)
...
[![Case B](https://yu-jack.github.io/images/sso/case-02.png)](https://yu-jack.github.io/images/sso/case-02.png)

[Case B](https://yu-jack.github.io/images/sso/case-02.png)
...
所以不用再驗證帳號密碼，接著被導轉到 AP2 manager 頁面
原因是, 我已經登入過了, 就不用再登入了
...
而不需要再去判斷 username 和 password 是否正確
...
<video width="100%" controls="" style="box-sizing: inherit; height: auto; max-width: 100%;"></video>
