---
kind: reprint
source: https://columns.chicken-house.net/2020/02/09/process-pool/
author: Andrew Wu
---

# [Part #5](https://columns.chicken-house.net/2020/02/09/process-pool/) 非同步任務的處理機制 - Process Pool
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-16-21-57-06.png)
...
測試空轉 10000 次 `HelloTask` 呼叫的結果: `InProcessWorker: ∞ tasks/sec` 一如預期，一樣跑到破表…
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-16-18-29-55.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-16-18-39-08.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-16-19-04-12.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-16-19-15-09.png)
...
2. 其他 task 吃太多 CPU 運算資源, 導致我的 code 無法分配足夠的 CPU time ..
3. 其他 task 誤觸某些共用 library 的 static properties / fields 影響我的 code 執行 ..
4. 其他 task 意外出現 Unhandled Exception, 導致整個 process 都被終止了, 影響我的 code 被中斷…
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-18-02-05-18.png)

如果這台 server 還有其他任務要跑 (至少要讓主程式好好的執行啊)，那有些地方應該要留意一下:

1. CPU Affinity: 處理器相關性, 可以指定你只要用哪幾個核心
2. Process Priority: 處理程序的優先權
...
![img](https://columns.chicken-house.net/wp-content/images/2020-02-09-process-pool/2020-02-18-02-14-24.png)
