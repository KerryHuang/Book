---
kind: reprint
source: https://columns.chicken-house.net/2019/06/01/nested-query/
author: Andrew Wu
---
...
2. 模擬 `dir /s /b c:\windows\system32\*.ini`, 找出所有位於 `c:\windows\system32` 目錄下 (包含子目錄) 所有副檔名為 `.ini` 的檔案清單
3. 模擬 `mkdir c:\windows\backup`
4. 模擬 `move c:\users c:\windows\backup`
5. 模擬 `rm /s /q c:\windows\backup` (叔叔有練過，好孩子不要學)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-30-23-00-38.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-27-23-19-57.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-27-23-43-08.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-27-23-28-02.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-00-03-05.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-00-20-07.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-00-19-20.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-23-37-47.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-00-59-41.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-01-19-38.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-02-15-00.png)

刪除後 (截錄片段):

![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-02-15-37.png)
...
[方案一](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1) 的方式，雖然能漂亮的用 SQL 語法解決問題，不過有經驗的人大概都感覺得出來，這樣的效能實在有很大的改善空間。一般 DBA 在處理的資料量，都是要在幾千萬筆，甚至上億筆的數量級之下，查詢還要能在瞬間傳回來的。想像一下如果這些資料是你雲端硬碟的檔案清單，光是查詢就花掉 8 sec, 你一定不會覺得這服務速度很快很好用… (如果這是用在目錄同步的 API，我相信你會為了同步速度而抓狂…)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-23-51-39.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-28-23-53-01.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-29-00-04-27.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-29-00-09-20.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-29-00-11-59.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-29-00-20-30.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-29-00-26-53.png)

執行時間: 00:00:00.067 (sec) 執行計畫 (Estimated Subtree Cost): 0.18752

看到查詢效能跟語法上的差異了嗎? 整個困難度跟 [方案1](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1) 完全是不同檔次的啊… 雖然 schema 的設計看起來蠢了一點 (好吧，我覺得非常蠢)，但是不得不說在效能跟查詢的困難度上來說是大勝啊!
...
同前面的 [方案1](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1)，接著我們來模擬 `move c:\users c:\windows\backup` :
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-29-01-02-46.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-30-23-11-42.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-31-00-12-10.png)

把標上的 index 呈現在數線上:

![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-31-00-12-59.png)
...
2. 要計算 clothing(1,22) 底下有多少節點，只要:
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-31-00-51-03.png)

執行時間: 00:02:33.591 (sec) 執行計畫 (Estimated Subtree Cost): 0.941395

這查詢看起來有點蠢，把目標節點(P)所有的子節點(C)都找出來，然後排除中間有其他節點(M)的部分…

這我覺得有點矯枉過正了。WIKI 的範例是額外加上 DEPTH 這個索引 (一樣你要在 tree 異動時自己維護這欄位)。我自己專案實作則是合併 [方案一](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1) 的 PARENT_ID，作法比較直覺。如果你像我一樣額外維護 PARENT_ID，那這個查詢的效能就會跟方案一一樣快跟簡潔。
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-31-01-13-38.png)

執行時間: 00:00:00.173 (sec) 執行計畫 (Estimated Subtree Cost): 0.167235

對比 [方案一](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1)，如果也試著查看看 `c:\windows\` 下的 `*.dll`, 看看結果:
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-31-01-14-07.png)

執行時間: 00:00:00.836 (sec) 執行計畫 (Estimated Subtree Cost): 10.7832

看出 [方案三](https://columns.chicken-house.net/2019/06/01/nested-query/#sol3) 特別的地方了嗎? 沒有 [方案一](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1) 糟糕的效能；幾乎跟 [方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 同等級秒返的效率，但是查詢的語法卻不會像 [方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 那樣隨著層級改變，難以寫成 store procedure, 索引固定為 LEFT_INDEX / RIGHT_INDEX 兩個欄位 (不像 [方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 要 20 個欄位，你還無法預期要對哪個欄位下過濾條件)。這樣的結構大幅簡化了查詢的語法，完全可以將它放到 store procedure, 搭配參數即可執行。
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-05-31-01-08-02.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-01-14-21.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-01-58-04.png)
...
1. **被搬移的 nodes 搬到暫存區**:
   ...
   ![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-02-04-25.png)
2. **目標 node 騰出空間**:
   B 原本只有 2 ~ 3 (沒有空間再放其他 nodes 了), 擴張到 B(2,9), 騰出待會可以放下三個 nodes 的空間。如果 B 還有其他兄弟 nodes, 也要一起配合挪出位子..
   ![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-02-08-40.png)
3. **把暫存區的 nodes 搬回來**:
   B(2,9) 騰出了 3 ~ 8 的 index, 原本被搬到暫存區的 C, D, E 經過計算，全部 index 位移 +9 就可以搬回來新位置了。
   ![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-02-10-23.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-13-46-20.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-01-17-27-21.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-02-03-58-03.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2019-06-01-nested-query/2019-06-02-03-58-40.png)

在大型的資料庫內，做遞迴的分類搜尋，你會發現 [方案一](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1) 使用了遞迴，這正是 RDBMS 最不擅長的計算，硬是執行 Query 的效果非常慘，完全不在同一個檔次身上。至於 [方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 及 [方案三](https://columns.chicken-house.net/2019/06/01/nested-query/#sol3)，雖說都很快，但是也差了接近 10 倍的時間。我是認為這個差距你可以參考，但是最終應該以整體考量來決定。因為 [方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 獲取效能的代價很高，尤其是在開發與維護方面。

[方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 最大的缺點，就在於 schema 的設計就限制住最大的階層數了。這個範例限制最大階層只能到 20 層；超過的話，TABLE schema 要追加欄位 (這對線上系統而言是大工程)，SQL 也要配合改寫 (這也是大工程)；SQL 也因為這些欄位，難以寫成靜態好維護的 SQL script, 容易不小心就埋下 SQL Injection 的風險。

也因此，除非你非常需要這 10X 的效能，而且你資料的來源、查詢方式、應用情境你都能嚴格的控制好層數上限，你也不在乎 SQL script 好不好維護的問題時，再考量這個做法。否則我會建議 [方案三](https://columns.chicken-house.net/2019/06/01/nested-query/#sol3) 是比較均衡可靠的選擇。
...
在資料庫的世界，用正確的方法 (schema, index, algorithm 等等) 帶來的效益, 遠高於用正確的工具；尤其是你的資料量已經到某個規模之上的時候。這次的範例，我除了 [方案一](https://columns.chicken-house.net/2019/06/01/nested-query/#sol1) 有用到部分 SQL 特殊語法 (CTE) 之外，其他都是很標準的用法而已。這幾年碰到越來越大規模的系統，越來越大的交易量，加上開始研究 cloud native / microservices 的設計哲學，我開始學到一件事:
...
畢竟 recursive 還是 C# 的強項啊，我用 ProcessFolder( ) 來進行遞迴的處理。過程中直接靠 stack 跟 context 的協助，把 [方案二](https://columns.chicken-house.net/2019/06/01/nested-query/#sol2) 需要的 20 層索引，還有 [方案三](https://columns.chicken-house.net/2019/06/01/nested-query/#sol3) 需要的 tree traversal 過程產生的 left / right index 都計算好。
