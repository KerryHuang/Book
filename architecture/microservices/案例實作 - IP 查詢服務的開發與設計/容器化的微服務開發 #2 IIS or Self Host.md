---
kind: reprint
source: https://columns.chicken-house.net/2018/05/12/msa-labs2-selfhost/
author: Andrew Wu
---

# [容器化的微服務開發 #2](https://columns.chicken-house.net/2018/05/12/msa-labs2-selfhost/) IIS or Self Host ?
...
![img](https://columns.chicken-house.net/wp-content/images/2018-05-12-msa-labs2-selfhost/2018-05-17-17-42-57.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2018-05-12-msa-labs2-selfhost/2018-05-17-21-25-51.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2018-05-12-msa-labs2-selfhost/2018-05-20-04-42-41.png)
...
![img](https://columns.chicken-house.net/wp-content/images/2018-04-06-aspnet-msa-labs2-consul/2018-05-07-21-01-35.png)
...
另一種是 OS 層級的事件，前面的 API 在 console mode 下不支援，因此我在 [Tips: 在 .NET Console Application 中處理 Shutdown 事件](https://columns.chicken-house.net/2018/05/10/tips-handle-shutdown-event/) 這篇文章內用 hidden window 來接收 message, 攔截 `WM_QUERYENDSESSION`。這邊我也把它包裝成 `form.shutdown` 這個 `ManualResetEvent` 來處理。在 `Main()` 中間有這麼段 code, 就是為了準備 hidden window, 好接收 shutdown message:
